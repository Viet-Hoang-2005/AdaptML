...
% Tài liệu độc lập, không phụ thuộc main.tex hoặc các section của đề cương cũ.
...
\begin{description}[font=\normalfont\bfseries,leftmargin=2.5em,labelwidth=2em,itemsep=0pt,topsep=0pt]
  \item[E1] \codepath{services/model-server/src/index.py}; \codepath{services/consumer/src/main.py}, \codepath{services/consumer/src/database.py}: event, persistence, offset và automatic-drift outbox.
  \item[E2] \codepath{services/machine-learning-serving/src/index.py}: predict và max confidence.
