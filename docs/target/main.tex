...
\newcommand{\cmark}{\textcolor{green!45!black}{\textbf{\checkmark}}}
\newcommand{\pmark}{\textcolor{orange!75!black}{\textbf{$\sim$}}}
\newcommand{\xmark}{\textcolor{red!60!black}{\textbf{$\times$}}}
\newcommand{\codepath}[1]{\texttt{\small #1}}

\title{\vspace{-1.2cm}\textbf{\Large Đánh giá kiến trúc MLOps và lộ trình Degradation-Aware CT}\\[0.3em]
