...
\hypersetup{
  ...
  pdftitle={Kiểm chứng suy giảm và kích hoạt tái huấn luyện dưới data drift với ngân sách nhãn hạn chế},
...
\title{\vspace{-1.2cm}\textbf{\Large Kiểm chứng suy giảm và kích hoạt tái huấn luyện\\dưới data drift với ngân sách nhãn hạn chế}\\[0.5em]
