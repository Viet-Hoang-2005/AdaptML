...
Trong replay, candidate pass được kích hoạt cho batch sau khi job/gate hoàn tất; champion cũ phục vụ trong thời gian chờ. Demo dùng chuyển version có kiểm soát. Không đồng nhất đăng ký version với cải thiện chất lượng hoặc tự động triển khai production.
