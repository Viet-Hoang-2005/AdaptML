...
Đối chiếu toàn diện 39 thành phần kiến trúc theo khung tham chiếu chuẩn mực của Amou Najafabadi \textit{et al.}~\cite{najafabadi2026}, hệ thống hiện đáp ứng trọn vẹn 14 thành phần ($35.9\%$), đáp ứng một phần 10 thành phần ($25.6\%$) và còn thiếu 15 thành phần ($38.5\%$). Bảng~\ref{tab:39-summary} và Hình~\ref{fig:component-map} tổng hợp chi tiết mức độ đáp ứng theo từng nhóm chức năng:
\begin{itemize}
  \item \textbf{Nhóm thế mạnh nền tảng (Infrastructure \& Supporting, Storage \& Versioning):} Đạt mức độ hoàn thiện cao nhất, cung cấp đầy đủ hạ tầng container (Kubernetes/K3s), messaging (Redpanda/Kafka), điều phối tác vụ (Celery) và quản lý phiên bản mô hình/artifact bất biến.
  \item \textbf{Nhóm trọng tâm cần nghiên cứu (Data Curation, Inference \& ML Training):} Là khu vực tồn tại các khoảng trống lớn nhất về vòng lặp phản hồi nhãn thực tế, chẩn đoán nguyên nhân suy giảm đa tín hiệu, cổng thẩm định đối kháng candidate--champion và điều phối lưu lượng shadow/canary. Đây chính là không gian đóng góp khoa học cốt lõi của đề tài nhằm đưa hệ thống tiến hóa lên biến thể Continuous Training thích ứng.
\end{itemize}

\begin{table}[htbp]
\centering
\caption{Tổng hợp mức độ đáp ứng 39 thành phần chức năng theo từng nhóm.}\label{tab:39-summary}
...
\subsection{Phân định Ranh giới Nền tảng (Platform Scope) và Phạm vi Nghiên cứu (Research Scope)}

Để tránh phân tán nguồn lực vào việc phát triển hệ thống mà thiếu chiều sâu khoa học, Bảng~\ref{tab:platform-vs-research} phân định rành mạch ranh giới giữa vai trò hạ tầng nền tảng và các cấp độ đóng góp nghiên cứu (Q3 $\rightarrow$ Q2 $\rightarrow$ Q1 Stretch):

\begin{xltabular}{\linewidth}{@{}L{3.8cm} L{3.0cm} C{1.6cm} C{1.8cm} Y@{}}
\caption{Phân định ranh giới giữa Hạ tầng Nền tảng và các Cấp độ Nghiên cứu.}\label{tab:platform-vs-research}\\
\toprule
\textbf{Thành phần chức năng} & \textbf{Vai trò Nền tảng (Platform)} & \textbf{Chuẩn Q3} & \textbf{Mở rộng Q2} & \textbf{Mục tiêu Q1 Stretch} \\
\midrule
\endfirsthead
\toprule
\textbf{Thành phần chức năng} & \textbf{Vai trò Nền tảng (Platform)} & \textbf{Chuẩn Q3} & \textbf{Mở rộng Q2} & \textbf{Mục tiêu Q1 Stretch} \\
...
Event Pipeline \& Logging & Hạ tầng thu thập & Hỗ trợ & Hỗ trợ & Hỗ trợ \\
\addlinespace
Data Drift \& Quality Checks & Bằng chứng vận hành & Sâu & Sâu & Sâu \\
\addlinespace
Concept Drift Monitoring & Bằng chứng nghiên cứu & Sâu & Sâu & Sâu \\
\addlinespace
Biểu diễn Đa bằng chứng & Cốt lõi nghiên cứu & \textbf{Core} & \textbf{Core} & \textbf{Core} \\
\addlinespace
Chẩn đoán Nguyên nhân & Cốt lõi nghiên cứu & \textbf{Core} & \textbf{Core} & \textbf{Core} \\
\addlinespace
Định lượng Severity \& Confidence & Cốt lõi nghiên cứu & \textbf{Core} & \textbf{Core} & \textbf{Core} \\
\addlinespace
Bộ Lựa chọn Chiến lược (Policy) & Cốt lõi nghiên cứu & \textbf{Core} & \textbf{Core} & \textbf{Core} \\
\addlinespace
Tái huấn luyện Gia tăng / Toàn phần & Hạ tầng thực thi CT & Hỗ trợ & Sâu & Sâu \\
\addlinespace
Vòng lặp Chuyên gia (HITL) & Rào chắn an toàn & Hỗ trợ & Sâu & Sâu \\
\addlinespace
Tối ưu Siêu tham số (HPO) & Nhánh mở rộng & Tùy chọn & Vừa phải & Sâu \\
\addlinespace
Shadow Mode \& Rollback & An toàn triển khai & Hỗ trợ & Hỗ trợ & Hỗ trợ \\
\addlinespace
Khái quát hóa Đa miền (Tasks) & Đánh giá thực nghiệm & 2--3 tasks & \textbf{Bắt buộc} & \textbf{Mạnh mẽ} \\
\addlinespace
Chẩn đoán Nhân quả (Causal) & Nghiên cứu dài hạn & Không & Tùy chọn & \textbf{Core tiềm năng} \\
\addlinespace
Online / Adaptive Policy Learning & Nghiên cứu dài hạn & Không & Tùy chọn & \textbf{Core tiềm năng} \\
\bottomrule
\end{xltabular}
