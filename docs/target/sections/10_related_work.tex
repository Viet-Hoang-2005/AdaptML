...
Bảng~\ref{tab:lit-gap} đối chiếu toàn diện đề tài nghiên cứu này với các công trình tiêu biểu trên y văn thế giới theo 8 tiêu chí chức năng cốt lõi:
...
\toprule
\textbf{Công trình / Framework} & \textbf{C1} & \textbf{C2} & \textbf{C3} & \textbf{C4} & \textbf{C5} & \textbf{C6} & \textbf{C7} & \textbf{Khoảng trống chưa giải quyết (Identified Research Gap)} \\
\midrule
\endfirsthead
\toprule
\textbf{Công trình / Framework} & \textbf{C1} & \textbf{C2} & \textbf{C3} & \textbf{C4} & \textbf{C5} & \textbf{C6} & \textbf{C7} & \textbf{Khoảng trống chưa giải quyết (Identified Research Gap)} \\
...
\textbf{Đề tài nghiên cứu (Đề xuất)} & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \textbf{Giải quyết trọn vẹn chuỗi khép kín:} Phát hiện đa tín hiệu $\rightarrow$ Chẩn đoán nguyên nhân \& Severity $\rightarrow$ Chính sách can thiệp an toàn (No-op/Data Eng/CT/HITL) $\rightarrow$ Evaluation Gate $\rightarrow$ Shadow/Canary. \\
\bottomrule
\end{xltabular}

\textit{Quy ước ký hiệu:} \cmark: Hỗ trợ đầy đủ; \pmark: Hỗ trợ một phần / mức khái niệm; \xmark: Chưa hỗ trợ / Khoảng trống nghiên cứu.
...
\begin{itemize}
  ...
  \item \textbf{C4 (Root-Cause Diagnosis):} Phân loại nguyên nhân suy giảm (7 nhóm) và định lượng mức độ nghiêm trọng ($S_0$--$S_4$).
  \item \textbf{C5 (Adaptive Action Space):} Không gian hành động đa nhánh (No-op, Data Engineering, Incremental CT, Full CT, HITL).
