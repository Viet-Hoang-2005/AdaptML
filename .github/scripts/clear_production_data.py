...
TARGET_TABLE = "nids_production_data"

def clear_production_data():
    print("=" * 50)
    print("🛡️   MLOps NIDS System - Clear Production Data Utility")
    print("=" * 50)
    ...
    try:
        ...
        print(f"❌ ERROR: Failed to clear data. The table might not exist yet.\nDetail: {e}")
        sys.exit(1)

if __name__ == "__main__":
    confirm = input(f"⚠️ WARNING: This will permanently delete ALL data in '{TARGET_TABLE}'. Are you sure? (y/n): ")
    if confirm.lower() == 'y':
