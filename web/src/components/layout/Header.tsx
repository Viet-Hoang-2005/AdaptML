...
export default function Header() {
  ...
  return (
    <header className="relative z-20 flex h-16 shrink-0 items-center justify-between border-b border-gray-200 bg-white px-5">
      ...
      <div className="absolute left-1/2 top-1/2 w-[min(420px,42vw)] -translate-x-1/2 -translate-y-1/2">
        <button
          ...
          className="flex h-10 w-full items-center justify-between gap-3 rounded-lg border border-gray-200 bg-white px-4 text-sm font-semibold text-gray-800 shadow-sm hover:border-gray-300"
        >
      ...
      <div className="flex min-w-48 items-center justify-end gap-2">
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-lg border border-gray-200 text-gray-500 hover:border-gray-300 hover:text-black"
