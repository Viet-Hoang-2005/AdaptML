...
export default function ApiKeyPage() {
  ...
  const columns: ColumnDef<ModelProject>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => <span className="text-muted-foreground">{row.original.description || t('apiKey.noDescription')}</span>,
    },
  ];
  ...
  return (
    <div className="flex w-full flex-col space-y-6">
      <PageHeader
        ...
        backLink={{ to: '/dashboard/settings/developer', label: t('apiKey.back') }}
      />
      ...
      <PageContent className="p-6 space-y-6">
        <div className="space-y-4">
          ...
          />
          <label htmlFor="input-api-key-description" className="flex flex-col gap-2 text-sm font-medium text-foreground">
          ...
          <div className="flex flex-col gap-2 pt-2">
            <span className="text-sm font-medium text-foreground">{t('apiKey.scope')}</span>
          ...
          <div className="flex flex-col gap-2 pt-4">
            <span className="text-sm font-medium text-foreground">{t('apiKey.python')}</span>
