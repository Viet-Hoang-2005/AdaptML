    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-overlay px-4">
      <div className="w-full max-w-xl rounded-surface border border-border bg-surface shadow-xl">
        ...
        <div className="px-5 py-5">
          <div className="rounded-surface border border-warning-border bg-warning-subtle px-4 py-3 text-sm text-warning">
            {description}
          </div>
          <div className="mt-4 rounded-surface border border-border bg-muted p-3">
            ...
            <div className="flex items-center gap-2">
              <code className="min-w-0 flex-1 break-all rounded-compact bg-surface px-3 py-2 text-sm font-semibold text-foreground">
                {apiKey}
              </code>
              <button
                type="button"
                onClick={onCopy}
                className="flex h-10 w-10 shrink-0 items-center justify-center rounded-surface border border-border bg-surface text-muted-foreground hover:text-foreground"
