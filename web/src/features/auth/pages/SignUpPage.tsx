...
export default function SignUpPage() {
  ...
  return (
    <AuthCard>
      ...
      <h2 className="mb-1 text-center text-2xl font-bold text-foreground">{t('signup.title')}</h2>
      <p className="mb-8 text-center text-sm text-muted-foreground">{t('signup.description')}</p>
      ...
      <p className="mt-8 text-center text-sm text-muted-foreground">
        {t('signup.hasAccount')}{' '}
        <Link to="/login" className="font-semibold text-white underline hover:opacity-60">
          {t('signup.signIn')}
        </Link>
      </p>
    </AuthCard>
