  ...
  return (
    <PageContent>
      <div className="border-b border-border p-6">
        <p className="text-xs font-semibold uppercase text-muted-foreground">{selectedModel.status}</p>
        <h2 className="mt-2 text-2xl font-bold text-foreground">{selectedModel.name}</h2>
