export const commonEn = {
  ...
  profile: { fallbackName: 'AI Engineer', signedIn: 'Signed in' },
  statuses: { registered: 'registered', loading: 'Loading...', loadingPage: 'Loading page', empty: 'No data available', error: 'Something went wrong' },
