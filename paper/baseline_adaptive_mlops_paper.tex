...
For each of 52 features, a two-sided KS test sets $I_j=1$ at uncorrected $p_j<\alpha=0.05$; no multiple-testing correction is applied. The dataset rule is $\rho\geq\tau_D$ with $\tau_D=0.30$. The reported mean KS is the mean test statistic and is descriptive, not the alert rule. The experiment is repeated over five random seeds (42, 123, 456, 789, 1024); Table~\ref{tab:drift-multilevel} reports the mean values.


\begin{table}[htbp]
\centering
\caption{Controlled challenger evaluation (mean over 5 seeds). Mean KS is descriptive across 52 features; $\Delta$M-F1 is computed before display rounding.}
...
\multirow{3}{*}{PortScan}
  ...
  & Moderate & 40\% & 0.233 & 0.375 & 1.000 & +0.625 \\
  & Severe   & 85\% & 0.496 & 0.130 & 1.000 & +0.869 \\
\midrule
\multirow{3}{*}{BruteForce}
  & Mild     & 15\% & 0.068 & 0.461 & 1.000 & +0.539 \\
  & Moderate & 40\% & 0.182 & 0.376 & 1.000 & +0.623 \\
  & Severe   & 85\% & 0.385 & 0.132 & 0.998 & +0.867 \\
\midrule
\multirow{3}{*}{WebAttacks}
  & Mild     & 15\% & 0.085 & 0.459 & 0.998 & +0.538 \\
  & Moderate & 40\% & 0.228 & 0.375 & 0.997 & +0.622 \\
  & Severe   & 85\% & 0.480 & 0.130 & 0.988 & +0.857 \\
\bottomrule
\end{tabular}
\end{table}
