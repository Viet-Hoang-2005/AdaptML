...
% TODO: Add system architecture overview figure showing Web/User, Control Plane, Native Registry/PostgreSQL, Object Storage, AWS Batch/Training Runner, Model Packager, Model Server, Redpanda/Consumer, Drift Monitoring, and deployment boundary.
% TODO: Add prototype screenshots only if page count remains within the 14-page limit.
% Candidate screenshots: training job detail, Model Evolution, drift report, CI/CD run, K3s status, AWS Batch job status.
