...
All nine windows satisfy the $0.30$ dataset rule (50--51 of 52 features drifted). As the attack fraction rises, mean KS increases from 0.07--0.10 to 0.38--0.50 and fixed-model Macro-F1 falls from 0.46 to 0.13; challengers recover to 0.988--1.000 ($\Delta$M-F1 of +0.54 to +0.87). Over five seeds, all standard deviations remain below 0.004. The near-perfect challenger scores reflect the i.i.d.\ split and well-separated CIC-IDS2017 features rather than general robustness; the primary signal is the recovery gap, not the absolute score. These results demonstrate lifecycle feasibility in this controlled setting, not robustness across environments or natural drift.
