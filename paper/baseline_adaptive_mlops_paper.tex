...
\begin{minipage}[t]{0.49\linewidth}
  ...
  \caption{Illustrative drift-report UI from a separate prototype run, not one of the nine controlled Table~\ref{tab:drift-multilevel} windows.}
  \label{fig:ui-drift}
\end{minipage}
\end{figure}
...
\multirow{3}{*}{PortScan}
  ...
  & Moderate & 40\% & 0.232 & 0.375 & 1.000 & +0.625 \\
  & Severe   & 85\% & 0.497 & 0.130 & 0.999 & +0.869 \\
\midrule
\multirow{3}{*}{BruteForce}
  & Mild     & 15\% & 0.068 & 0.462 & 1.000 & +0.538 \\
  & Moderate & 40\% & 0.181 & 0.377 & 1.000 & +0.623 \\
  & Severe   & 85\% & 0.384 & 0.133 & 1.000 & +0.867 \\
\midrule
\multirow{3}{*}{WebAttacks}
  & Mild     & 15\% & 0.085 & 0.459 & 0.997 & +0.537 \\
  & Moderate & 40\% & 0.228 & 0.375 & 0.996 & +0.621 \\
  & Severe   & 85\% & 0.480 & 0.130 & 0.981 & +0.851 \\
\bottomrule
\end{tabular}
\end{table}

All nine windows satisfy the $0.30$ dataset rule, with 50--51 of 52 features marked drifted in the stored results. As the controlled attack fraction rises, mean KS increases from 0.07--0.10 to 0.38--0.50 and fixed-model Macro-F1 falls from about 0.46 to 0.13. The corresponding challengers achieve Macro-F1 of 0.981--1.000. These near-perfect values may reflect highly separable selected attack patterns and the constructed BENIGN/ATTACK mixtures. They demonstrate lifecycle feasibility only in this controlled setting, not robustness across environments, natural drift, or general adaptation effectiveness.
