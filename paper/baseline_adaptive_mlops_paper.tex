...
All nine windows satisfy the $0.30$ dataset rule, with 50--51 of 52 features marked drifted in the stored results. As the controlled attack fraction rises, mean KS increases from 0.07--0.10 to 0.39--0.49 and fixed-model Macro-F1 falls from about 0.46 to 0.13. The corresponding challengers achieve Macro-F1 of 0.983--1.000. These near-perfect values may reflect highly separable selected attack patterns and the constructed BENIGN/ATTACK mixtures. They demonstrate lifecycle feasibility only in this controlled setting, not robustness across environments, natural drift, or general adaptation effectiveness.
