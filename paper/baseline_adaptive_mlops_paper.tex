...
Drift is measured using the Kolmogorov--Smirnov (KS) test at $p < 0.05$ over 52 flow features. We report the \emph{mean KS statistic} as a continuous drift magnitude indicator. Table~\ref{tab:drift-multilevel} summarizes the results.
