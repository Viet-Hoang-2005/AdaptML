...
from registry.views import (
    ...
    RegistryAliasResolveView,
    RegistryVersionDetailView,
    RegistryVersionBuildPackageView,
    RegistryVersionCheckHealthView,
    RegistryVersionDeployView,
    RegistryVersionHistoryView,
    RegistryVersionMetricsView,
    RegistryVersionPromoteView,
    RegistryVersionSmokeTestView,
...
urlpatterns = [
    ...
    path(
        "families/<int:family_id>/versions/<int:version_id>/promote/",
        RegistryVersionPromoteView.as_view(),
        name="registry_version_promote",
    ),
    path(
        "families/<int:family_id>/aliases/<str:alias_name>/predict/",
        RegistryAliasResolveView.as_view(),
        name="registry_alias_predict",
    ),
    path(
    ...
    path("versions/<int:version_id>/build-package/", RegistryVersionBuildPackageView.as_view(), name="registry_version_build_package"),
    path("versions/<int:version_id>/deploy/", RegistryVersionDeployView.as_view(), name="registry_version_deploy"),
    path("versions/<int:version_id>/check-health/", RegistryVersionCheckHealthView.as_view(), name="registry_version_check_health"),
    path("versions/<int:version_id>/smoke-test/", RegistryVersionSmokeTestView.as_view(), name="registry_version_smoke_test"),
