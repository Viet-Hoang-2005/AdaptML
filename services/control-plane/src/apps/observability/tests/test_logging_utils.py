...
class LoggingTests(unittest.TestCase):
    ...
    def test_overflow_does_not_hide_server_errors_behind_warnings(self):
        ...
        try:
            ...
            self.assertEqual(self.output.getvalue().count("error_key=other.ERROR"), before + 1)
    ...
    def test_summary_empty_success_failure_recovery_and_close(self):
        ...
        summary.recovery("database")
        summary.recovery("database")
        self.assertEqual(self.output.getvalue().count("event=ingestion.summary.recovered"), 1)
        summary.close()
        summary.close()
