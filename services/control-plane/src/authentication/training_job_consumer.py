...
def _do_refresh_status(job):
    ...
    from orchestration.sagemaker_service import refresh_sagemaker_training_job
...
@database_sync_to_async
def _get_logs(job):
    from orchestration.aws_batch_training_service import (
...
def _get_metrics(job):
    from orchestration.aws_batch_training_service import get_training_metrics_payload
...
@database_sync_to_async
def _get_events(job):
    from orchestration.training_job_views import serialize_training_job_event
