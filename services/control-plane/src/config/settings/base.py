...
UNSAVED_BUILD_IMAGE_TTL_SECONDS = env_int("UNSAVED_BUILD_IMAGE_TTL_SECONDS", 86400)
UNSAVED_BUILD_IMAGE_CLEANUP_INTERVAL_SECONDS = env_int(
    "UNSAVED_BUILD_IMAGE_CLEANUP_INTERVAL_SECONDS", 3600
)
CELERY_BEAT_SCHEDULE = {
    "cleanup-unsaved-build-images": {
        "task": "apps.deployment.tasks.cleanup_unsaved_build_images",
        "schedule": UNSAVED_BUILD_IMAGE_CLEANUP_INTERVAL_SECONDS,
    }
}
